...
source("Functions.R")
management_fcn(country="Argentina")
country="Argentina"
```
...
summary_fcn(country="Argentina")
```

```{r, warning=F, echo=F, message=F, fig.width=10, fig.height=7}
weapons_fcn(country="Argentina")
```

```{r, warning=F, echo=F, message=F, fig.width=10, fig.height=5}
builder_fcn(country="Argentina")
class_fcn(country="Argentina")
```
...
individual_fcn(country="Argentina")
```
