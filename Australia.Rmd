...
source("Functions.R")
management_fcn(country="Australia")
country="Australia"
```
...
summary_fcn(country="Australia")
```

```{r, warning=F, echo=F, message=F, fig.width=10, fig.height=7}
weapons_fcn(country="Australia")
```

```{r, warning=F, echo=F, message=F, fig.width=10, fig.height=5}
builder_fcn(country="Australia")
class_fcn(country="Australia")
```
...
individual_fcn(country="Australia")
```
